...
use crate::controls::{NavState, OrbitControls};
use crate::framebuffer::Framebuffer;
use crate::importdata::ImportData;
use crate::render::math::*;
use crate::render::*;
use crate::utils::{gl_check_error, print_context_info, print_elapsed, FrameTimer};
...
impl GltfViewer {
    ...
    pub fn screenshot(&mut self, filename: &str) -> DynamicImage {
        self.draw();
    ...
    pub fn multiscreenshot(&mut self, filename: &str, count: u32) -> Vec<DynamicImage> {
        ...
        for i in 1..=count {
            ...
            let image = self.screenshot(&actual_name[..]);
            images.push(image);
        }
        images
    }
